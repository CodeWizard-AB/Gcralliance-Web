...
import { researchProcesses } from "@/lib/constants";
...
export default function ResearchProcess() {
	return (
		<section
			...
			className="scroll-mt-24 pb-20 md:pb-32"
				...
				<div className="grid gap-10 lg:grid-cols-[minmax(0,340px)_1fr] lg:gap-14 xl:grid-cols-[minmax(0,380px)_1fr]">
					<div className="text-center lg:sticky lg:top-28 lg:self-start lg:text-left">
						...
						<p className="mt-4 text-pretty text-base leading-relaxed text-muted-foreground sm:text-lg">
							A structured, mentored path guiding researchers from early-stage
							concepts to successful publication in reputable journals.
						</p>
					...
					<ol className="flex flex-col gap-4 sm:gap-5">
						{researchProcesses.map(({ id, index, title, body, icon: Icon }) => (
							<li key={id}>
